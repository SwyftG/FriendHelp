...
public class ActivityActivity extends AppCompatActivity
    ...
    private Handler handler = new Handler(){
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case 1:
                    View v = View.inflate(ActivityActivity.this, R.layout.nav_header_home, null);
                    ...
                    navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
                        ...
                        public boolean onNavigationItemSelected(MenuItem item) {
                            ...
                            if (id == R.id.nav_home) {
                                ...
                                Intent intent = new Intent(ActivityActivity.this,FriendActivity.class);
                                startActivity(intent);
                                finish();
                            } else if (id == R.id.nav_schedual) {
                                Intent intent = new Intent(ActivityActivity.this,SchedualActivity.class);
                                startActivity(intent);
                                finish();
                                ...
                                Intent intent = new Intent(ActivityActivity.this,SettingActivity.class);
                                startActivity(intent);
                                finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityActivityFragment fragment = new ActivityActivityFragment();
        transaction.replace(R.id.activity_activity_listView, fragment);
        transaction.commit();
    }
