...
public class SchedualActivity extends AppCompatActivity
    ...
    private Handler handler = new Handler(){
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case 1:
                    View v = View.inflate(SchedualActivity.this, R.layout.nav_header_home, null);
                    ...
                    navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
                        ...
                        public boolean onNavigationItemSelected(MenuItem item) {
                            ...
                            if (id == R.id.nav_home) {
                                Intent intent = new Intent(SchedualActivity.this,HomeActivity.class);
                                startActivity(intent);
                                finish();
                            } else if (id == R.id.nav_friend) {
                                Intent intent = new Intent(SchedualActivity.this,FriendActivity.class);
                                startActivity(intent);
                                finish();
                            } else if (id == R.id.nav_schedual) {

                            } else if (id == R.id.nav_profile) {
                                Intent intent = new Intent(SchedualActivity.this,ProfileActivity.class);
                                startActivity(intent);
                                finish();
                            } else if (id == R.id.nav_activity) {
                                Intent intent = new Intent(SchedualActivity.this,ActivityActivity.class);
                                startActivity(intent);
                                finish();
                            } else if (id == R.id.nav_setting) {
                                Intent intent = new Intent(SchedualActivity.this,SettingActivity.class);
                                startActivity(intent);
                                finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_schdedual);
        ...
        SchedualActivityFragment mFriendActivityFragment = new SchedualActivityFragment();
        transaction.replace(R.id.schedual_activity_content_listview, mFriendActivityFragment);
        transaction.commit();
